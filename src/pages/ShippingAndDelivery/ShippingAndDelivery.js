      ...
      <Navbar />
        ...
        <div className="container mx-auto px-4">
          <div className="w-full md:w-10/12 mx-auto pt-8 pb-16 text-lg">
            <h1 className="border-l-4 border-red-600 pl-4 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Shipping Costs</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Free Shipping Information</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500">International Shipping</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500">Shipping Status</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Furniture and Oversized Items</h1>
              <p className="mt-4 text-xl">Etiam accumsan leo sem, sit amet faucibus ex convallis fermentum. Nunc tristique, eros eget rutrum accumsan, dolor quam varius nisl, ut euismod arcu urna a lectus. Mauris at dapibus metus.</p>
          </div>                
        </div>
        </div>
