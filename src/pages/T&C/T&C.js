      ...
      <Navbar />
        ...
        <div className="container mx-auto px-4">
          <div className="w-full md:w-10/12 mx-auto pt-8 pb-16 text-lg">
            <h1 className="border-l-4 border-red-600 pl-4 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Intellectual Property</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Terminatio</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Changes To This Agreement</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Contact Us</h1>
