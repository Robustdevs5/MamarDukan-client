...
<<<<<<< HEAD
        ...
        <div className="container mx-auto px-4">
          <div className="w-full md:w-10/12 mx-auto pt-8 pb-16 text-lg">
            <h1 className="border-l-4 border-red-600 pl-4 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> Mamar Dukan Privacy Policy</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> PERSONAL INFORMATION WE COLLECT</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> HOW DO WE USE YOUR PERSONAL INFORMATION?</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> DO NOT TRACK</h1>
              ...
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> BEHAVIORAL ADVERTISING</h1>
              <p className="mt-4 text-xl">Etiam accumsan leo sem, sit amet faucibus ex convallis fermentum. Nunc tristique, eros eget rutrum accumsan, dolor quam varius nisl, ut euismod arcu urna a lectus. Mauris at dapibus metus.</p>
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> YOUR RIGHTS</h1>
              <p className="mt-4 text-xl">Etiam accumsan leo sem, sit amet faucibus ex convallis fermentum. Nunc tristique, eros eget rutrum accumsan, dolor quam varius nisl, ut euismod arcu urna a lectus. Mauris at dapibus metus.</p>
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> DATA RETENTION</h1>
              <p className="mt-4 text-xl">Etiam accumsan leo sem, sit amet faucibus ex convallis fermentum. Nunc tristique, eros eget rutrum accumsan, dolor quam varius nisl, ut euismod arcu urna a lectus. Mauris at dapibus metus.</p>
              <h1 className="border-l-4 border-red-600 pl-4 mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500"> GDPR & Mamar Dukan</h1>
              <p className="mt-4 text-xl">Etiam accumsan leo sem, sit amet faucibus ex convallis fermentum. Nunc tristique, eros eget rutrum accumsan, dolor quam varius nisl, ut euismod arcu urna a lectus. Mauris at dapibus metus.</p>
          </div>                
=======
      ...
      <div className="container mx-auto px-4">
        <div className="w-full md:w-10/12 mx-auto pt-8 pb-16 text-lg">
          <h1 className="font-semibold text-2xl md:text-3xl font-heading text-grey-500">
            {" "}
            Mamar Dukan Privacy Policy
          </h1>
          <p className="mt-4 text-md">
          Welcome to the Mamar Dukan website (the "Site") operated by Mamar Dukan Bangladesh Ltd. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.
...
You can visit the Site and browse without having to provide personal details. During your visit to the Site you remain anonymous and at no time can we identify you unless you have an account on the Site and log on with your user name and password.
          ...
          <h1 className="mt-6 font-semibold text-2xl md:text-3xl font-heading text-grey-500">
            {" "}
