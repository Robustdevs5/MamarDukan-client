...
import { removeWishlistToDb } from './WishListCartDatabase';
      ...
      >
        <section className="h-full flex flex-col  shadow-xl  ">
          <div className="flex-1 py-6 overflow-y-auto sm:px-6 px-2">
            <h4 className="text-lg font-medium text-gray-900 border-l-4 border-red-600 pl-3">Wishlist Product</h4>
            <hr/>
