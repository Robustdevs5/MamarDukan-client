        ...
        {product.map(product =>
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200">
              <img alt="ecommerce" src={product.img} />
            </div>

            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">BRAND NAME: {product.brand}</h2>
              ...
              <ul className="list-disc space-y-2">
                <li className="flex items-start">
                  ...
                  <p className="ml-2">Unrestrained and portable active stereo speaker</p>
                </li>
                <li className="flex items-start">
                  <span className="h-6 flex items-center sm:h-7">
                    <svg className="flex-shrink-0 h-5 w-5 text-cyan-500" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <p className="ml-2">Free from the confines of wires and chords</p>
                </li>
                <li className="flex items-start">
                  <span className="h-6 flex items-center sm:h-7">
                    <svg className="flex-shrink-0 h-5 w-5 text-cyan-500" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <p className="ml-2">20 hours of portable capabilities</p>
                </li>
              </ul>
