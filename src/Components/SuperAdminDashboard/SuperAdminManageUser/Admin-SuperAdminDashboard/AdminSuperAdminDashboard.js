        ...
        <div className=" ">
            ...
            <DashboardContainer>
                ...
                <div className="md:w-5/6 w-full h-screen scrollBar">
                    ...
                    <h1 className="mt-3 text-2xl font-bold text-gray-900 m-2 border-l-2 border-red-600 pl-2 tracking-tighter">All Admin Details</h1>
                    <DataTable Data={Admin} />
                    <div className="bg-white rounded p-8">
                        <h1 className="mt-3 text-2xl font-bold text-gray-900 m-2 border-l-2 border-red-600 pl-2 tracking-tighter">Add New Admin</h1>
                        <AddAdminForm />
                    </div>
                </div>
