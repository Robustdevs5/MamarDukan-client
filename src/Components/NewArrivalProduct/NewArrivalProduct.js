...
const NewArrivalProduct = () => {
    return (
        <div className="px-8">
        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900">New Arrival Product</h2>

        <div className="my-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-6 lg:grid-rows-2 lg:grid-flow-col xl:gap-4">
            
            <div className="relative w-full bg-white border cursor-pointer">
                ...
                <div className="mt-4 pl-2 mb-2 flex justify-between ">
                    <div>
                    <p className="text-lg font-semibold text-gray-900 mb-0">Russell Hobbs Kettle Premium Stainlessteel</p>
