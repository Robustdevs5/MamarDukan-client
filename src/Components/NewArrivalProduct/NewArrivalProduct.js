...
const NewArrivalProduct = () => {
    return (
        <div className="px-8">
        <h2 className="tracking-tighter uppercase sm:text-3xl text-gray-800 font-bold py-2 my-4 md:py-2 md:my-0 border-b-2 border-blue-500 md:border-none">New Arrival Product</h2>
